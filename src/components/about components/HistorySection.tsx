...
import {
  Trophy, Users, Zap, Building, Gamepad2, Monitor, Award, ShoppingCart,
  Handshake, Rocket, Expand, Minimize2
} from "lucide-react";
...
export default function HistorySection() {
  ...
  return (
    <section ref={sectionRef} className="py-20 bg-gaming-dark relative">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 md:mb-6 text-amber-50">
            Nossa Jornada Épica
          </h2>
